...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_InteractButton p_InteractButton;
        ...
        public static SteamVR_Input_ActionSet_InteractButton InteractButton
        {
            get
            {
                return SteamVR_Actions.p_InteractButton.GetCopy<SteamVR_Input_ActionSet_InteractButton>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_InteractButton = ((SteamVR_Input_ActionSet_InteractButton)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_InteractButton>("/actions/InteractButton")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.InteractButton};
        }
    }
}
